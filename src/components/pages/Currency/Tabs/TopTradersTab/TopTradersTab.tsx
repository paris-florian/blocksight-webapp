...
import styles from "./TopTradersTab.module.css";
...
export const TopTradersTab = () => {
   const [filterValues, setFilterValues] = useState<IFilterValue[]>([
     // Default filter for influencer tag - using the correct value from the labelOptions
    //  {
    //    fieldName: "tags",
    //    operator: "in" as any,
    //    value: [], // Correct value for 'Influencer' based on labelOptions
    //    type: "tags"
    //  }
   ]);
