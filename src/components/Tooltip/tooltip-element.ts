...
export class TooltipElement {
	...
	private _valueElements: HTMLDivElement[] = [];
	...
	public updateTooltipContent(tooltipContentData: TooltipContentData) {
		...
		// setElementText(this._timeElement, tooltipContentData.values);
	}
...
export function applyStyle(element: HTMLElement, styles: Record<string, string>) {
